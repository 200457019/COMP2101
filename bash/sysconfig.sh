...
function error-message {
    echo  "ERROR: There is some error" >&2
}
...
function error-exit {
    echo "ERROR: Closing program"
    exit
}
#This function displays help information if the user asks for it on the command line or gives us a bad command line
function displayhelp {
    echo "This script shows system information and you can use options 
    [--help | host | domain | ipconfig | os | cpu | memory | disk | printer]
